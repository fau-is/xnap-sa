...
if __name__ == '__main__':
    ...
    if args.mode == 0:
        ...
        for prefix_index in range(2, len(process_instance)):
            ...
            predicted_act_class, target_act_class, target_act_class_str, prefix_words, model, input_encoded, prob_dist = test.test_prefix(args, preprocessor, process_instance, prefix_index)
