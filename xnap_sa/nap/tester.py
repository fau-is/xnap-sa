        ...
        for prefix_size in range(1, preprocessor.get_max_case_length(event_log)):  # for prefix_size >= 1
            ...
            for case in test_cases:
                ...
                for current_prediction_size in range(prediction_size):
                    ...
                    if args.classifier == 'RF' or args.classifier == "DT" or args.classifier == "LD" or \
                            args.classifier == "KNN" or args.classifier == "LR" or args.classifier == "LDA":
                        ...
                        if args.classifier == 'LR' or args.classifier == "KNN" or args.classifier == "NB" or args.classifier == "LDA":
                            scaler = utils.load_nap_model(args, best_model_id, True)
...
def test_manipulated_prefixes(args, preprocessor, event_log, manipulated_prefixes, test_indices, prefixes_ids_rel):
    """
    ...
    with open(utils.get_output_path_predictions(args), 'w') as result_file_fold:
        ...
        for idx_case, manipulated_case in enumerate(manipulated_prefixes):
            # For each manipulated prefix
            for subseq in manipulated_case:

                if prefixes_ids_rel[prefixes_id]:
...
def store_prediction(args, result_writer, case, prefix_size, ground_truth, prediction):
    """ Writes evaluation into a result file """
