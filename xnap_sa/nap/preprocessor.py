...
class Preprocessor(object):
    ...
    def encode_data(self, args, df):
        ...
        if args.classifier == 'RF' or args.classifier == "DT" or args.classifier == "LD" or \
                args.classifier == "KNN" or args.classifier == "LR" or args.classifier == "NB" or args.classifier == "LDA":
    ...
    def get_features_tensor(self, args, event_log, subseq_cases):
        ...
        if args.classifier == 'RF' or args.classifier == "DT" or args.classifier == "LD" or args.classifier == "KNN" \
                or args.classifier == "LR" or args.classifier == "NB" or args.classifier == "LDA":
