from xnap_sa.exp.lrp.LSTM.LSTM_bidi import LSTM_bidi
import numpy as np
...
def calc_relevance_score_prefix(args, preprocessor, prefix_words, model, features_tensor_reshaped, tar_act_id):
    ...
    # perform LRP
    eps = args.lrp_eps  # small positive number, default = 0.001
    bias_factor = args.lrp_bias_factor  # recommended value, default = 0.0
